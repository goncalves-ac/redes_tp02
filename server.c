...
//void serverUsage
//(int argc, char *argv[]) { // inform how to use the program
...
//        }
//
//    } else if (strcmp(recuperarIdMensagem(buf), "05") == 0) // Equipment requests information about some equipment in database and server response.
//    {
...
//            }
//        }
//    } else if (strcmp(recuperarIdMensagem(buf), "09") == 0) // code created to return the equipment list to the requesting equipment
//    {
